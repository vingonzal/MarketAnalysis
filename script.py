...
#         # loop through each element store
...
#     #call function that creates a csv and writes data to the file(s)
#     create_csv_files(book_category, full_links, element_headings) 
# #Open a new file to write to called ‘{category]-bookCategoryData.csv’
# def create_csv_files(book_category, full_links, element_headings):
